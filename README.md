...
<p align="center">
  <img
    ...
    alt="Big Five Personality Traits"
    width="600"
    height="640"
  />
</p>

The relationship between handwriting and personality analysis is studied within the field of **graphology**. Graphology is a field of study that aims to draw conclusions about a person's personality and character traits based on their handwriting. This approach has found application in various disciplines such as forensic investigations, human resources processes, psychological counseling, and education.

In this study, deep learning methods were used to analyze personality traits from individuals' handwriting samples. Instead of classical graphology feature extraction techniques, the pre-trained **Vision Transformer (ViT)** architecture from ImageNet was preferred, and feature extraction and classification processes were modeled. Personality prediction was performed based on the **Big Five Personality Model (Five Major Personality Traits – OCEAN)**.

<p align="center">
<img width="792" height="480" alt="image" src="https://github.com/user-attachments/assets/0b227c88-fb1f-401d-8266-86a7fd97683f" />
</p>
